...
<div class="max-w-7xl mx-auto px-4">
    ...
    <div class="control">
        <button onclick="{{route('entreprises.edit', $entreprise->id)}}" class="w-full h-11 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 font-medium">Modifier</button>
