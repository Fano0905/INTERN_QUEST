...
<body>
    <form action="{{route('offers.store')}}" method="POST">
        ...
        <div class="relative mb-6">
            ...
            <input type="text" name="date_offer" id="date_offer" required placeholder="jj/mm/aaaa" class="w-full pl-10 pr-3 py-1 bg-transparent border-b-2 border-blue-600 outline-none focus:border-blue-400">
