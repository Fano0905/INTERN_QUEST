...
<div class="form-control">
    <form action="{{route('applications.store')}}" method="POST">
        ...
        <a href="{{route('interquest/')}}"><button class="w-full h-11 bg-gray-600 text-white rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 font-medium">Annuler</button>
    </form>
    <a href="{{ url()->previous() }}">
